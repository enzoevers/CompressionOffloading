...
#line 92 "dtc.p/dtc-parser.tab.c"
...
#line 102 "../git/dtc-parser.y"
                {
			parser_output = build_dt_info((yyvsp[-2].flags), (yyvsp[-1].re), (yyvsp[0].node),
			                              guess_boot_cpuid((yyvsp[0].node)));
		}
#line 1391 "dtc.p/dtc-parser.tab.c"
    break;

  case 3: /* header: DT_V1 ';'  */
#line 110 "../git/dtc-parser.y"
                {
			(yyval.flags) = DTSF_V1;
		}
#line 1399 "dtc.p/dtc-parser.tab.c"
    break;

  case 4: /* header: DT_V1 ';' DT_PLUGIN ';'  */
#line 114 "../git/dtc-parser.y"
                {
			(yyval.flags) = DTSF_V1 | DTSF_PLUGIN;
		}
#line 1407 "dtc.p/dtc-parser.tab.c"
    break;

  case 6: /* headers: header headers  */
#line 122 "../git/dtc-parser.y"
                {
			if ((yyvsp[0].flags) != (yyvsp[-1].flags))
				ERROR(&(yylsp[0]), "Header flags don't match earlier ones");
			(yyval.flags) = (yyvsp[-1].flags);
		}
#line 1417 "dtc.p/dtc-parser.tab.c"
    break;

  case 7: /* memreserves: %empty  */
#line 131 "../git/dtc-parser.y"
                {
			(yyval.re) = NULL;
		}
#line 1425 "dtc.p/dtc-parser.tab.c"
    break;

  case 8: /* memreserves: memreserve memreserves  */
#line 135 "../git/dtc-parser.y"
                {
			(yyval.re) = chain_reserve_entry((yyvsp[-1].re), (yyvsp[0].re));
		}
#line 1433 "dtc.p/dtc-parser.tab.c"
    break;

  case 9: /* memreserve: DT_MEMRESERVE integer_prim integer_prim ';'  */
#line 142 "../git/dtc-parser.y"
                {
			(yyval.re) = build_reserve_entry((yyvsp[-2].integer), (yyvsp[-1].integer));
		}
#line 1441 "dtc.p/dtc-parser.tab.c"
    break;

  case 10: /* memreserve: DT_LABEL memreserve  */
#line 146 "../git/dtc-parser.y"
                {
			add_label(&(yyvsp[0].re)->labels, (yyvsp[-1].labelref));
			(yyval.re) = (yyvsp[0].re);
		}
#line 1450 "dtc.p/dtc-parser.tab.c"
    break;

  case 13: /* devicetree: '/' nodedef  */
#line 156 "../git/dtc-parser.y"
                {
			(yyval.node) = name_node((yyvsp[0].node), "");
		}
#line 1458 "dtc.p/dtc-parser.tab.c"
    break;

  case 14: /* devicetree: devicetree '/' nodedef  */
#line 160 "../git/dtc-parser.y"
                {
			(yyval.node) = merge_nodes((yyvsp[-2].node), (yyvsp[0].node));
		}
#line 1466 "dtc.p/dtc-parser.tab.c"
    break;

  case 15: /* devicetree: dt_ref nodedef  */
#line 164 "../git/dtc-parser.y"
                {
			/*
...
#line 1484 "dtc.p/dtc-parser.tab.c"
    break;

  case 16: /* devicetree: devicetree DT_LABEL dt_ref nodedef  */
#line 178 "../git/dtc-parser.y"
                {
...
#line 1499 "dtc.p/dtc-parser.tab.c"
    break;

  case 17: /* devicetree: devicetree DT_PATH_REF nodedef  */
#line 189 "../git/dtc-parser.y"
                {
			/*
			 * We rely on the rule being always:
			 *   versioninfo plugindecl memreserves devicetree
...
#line 1522 "dtc.p/dtc-parser.tab.c"
    break;

  case 18: /* devicetree: devicetree DT_LABEL_REF nodedef  */
#line 208 "../git/dtc-parser.y"
                {
			struct node *target = get_node_by_ref((yyvsp[-2].node), (yyvsp[-1].labelref));
...
#line 1545 "dtc.p/dtc-parser.tab.c"
    break;

  case 19: /* devicetree: devicetree DT_DEL_NODE dt_ref ';'  */
#line 227 "../git/dtc-parser.y"
                {
			struct node *target = get_node_by_ref((yyvsp[-3].node), (yyvsp[-1].labelref));
...
#line 1561 "dtc.p/dtc-parser.tab.c"
    break;

  case 20: /* devicetree: devicetree DT_OMIT_NO_REF dt_ref ';'  */
#line 239 "../git/dtc-parser.y"
                {
			struct node *target = get_node_by_ref((yyvsp[-3].node), (yyvsp[-1].labelref));
...
#line 1687 "dtc.p/dtc-parser.tab.c"
    break;

  case 33: /* propdata: propdataprefix DT_INCBIN '(' DT_STRING ')'  */
#line 325 "../git/dtc-parser.y"
                {
...
#line 1701 "dtc.p/dtc-parser.tab.c"
    break;

  case 34: /* propdata: propdata DT_LABEL  */
#line 335 "../git/dtc-parser.y"
                {
			(yyval.data) = data_add_marker((yyvsp[-1].data), LABEL, (yyvsp[0].labelref));
		}
#line 1709 "dtc.p/dtc-parser.tab.c"
    break;

  case 35: /* propdataprefix: %empty  */
#line 342 "../git/dtc-parser.y"
                {
			(yyval.data) = empty_data;
		}
#line 1717 "dtc.p/dtc-parser.tab.c"
    break;

  case 36: /* propdataprefix: propdata ','  */
#line 346 "../git/dtc-parser.y"
                {
			(yyval.data) = (yyvsp[-1].data);
		}
#line 1725 "dtc.p/dtc-parser.tab.c"
    break;

  case 37: /* propdataprefix: propdataprefix DT_LABEL  */
#line 350 "../git/dtc-parser.y"
                {
			(yyval.data) = data_add_marker((yyvsp[-1].data), LABEL, (yyvsp[0].labelref));
		}
#line 1733 "dtc.p/dtc-parser.tab.c"
    break;

  case 38: /* arrayprefix: DT_BITS DT_LITERAL '<'  */
#line 357 "../git/dtc-parser.y"
                {
...
#line 1758 "dtc.p/dtc-parser.tab.c"
    break;

  case 39: /* arrayprefix: '<'  */
#line 378 "../git/dtc-parser.y"
                {
			(yyval.array).data = data_add_marker(empty_data, TYPE_UINT32, NULL);
			(yyval.array).bits = 32;
		}
#line 1767 "dtc.p/dtc-parser.tab.c"
    break;

  case 40: /* arrayprefix: arrayprefix integer_prim  */
#line 383 "../git/dtc-parser.y"
                {
...
#line 1790 "dtc.p/dtc-parser.tab.c"
    break;

  case 41: /* arrayprefix: arrayprefix dt_ref  */
#line 402 "../git/dtc-parser.y"
                {
...
#line 1808 "dtc.p/dtc-parser.tab.c"
    break;

  case 42: /* arrayprefix: arrayprefix DT_LABEL  */
#line 416 "../git/dtc-parser.y"
                {
			(yyval.array).data = data_add_marker((yyvsp[-1].array).data, LABEL, (yyvsp[0].labelref));
		}
#line 1816 "dtc.p/dtc-parser.tab.c"
    break;

  case 45: /* integer_prim: '(' integer_expr ')'  */
#line 425 "../git/dtc-parser.y"
                {
			(yyval.integer) = (yyvsp[-1].integer);
		}
#line 1824 "dtc.p/dtc-parser.tab.c"
    break;

  case 48: /* integer_trinary: integer_or '?' integer_expr ':' integer_trinary  */
#line 436 "../git/dtc-parser.y"
                                                          { (yyval.integer) = (yyvsp[-4].integer) ? (yyvsp[-2].integer) : (yyvsp[0].integer); }
#line 1830 "dtc.p/dtc-parser.tab.c"
    break;

  case 50: /* integer_or: integer_or DT_OR integer_and  */
#line 441 "../git/dtc-parser.y"
                                       { (yyval.integer) = (yyvsp[-2].integer) || (yyvsp[0].integer); }
#line 1836 "dtc.p/dtc-parser.tab.c"
    break;

  case 52: /* integer_and: integer_and DT_AND integer_bitor  */
#line 446 "../git/dtc-parser.y"
                                           { (yyval.integer) = (yyvsp[-2].integer) && (yyvsp[0].integer); }
#line 1842 "dtc.p/dtc-parser.tab.c"
    break;

  case 54: /* integer_bitor: integer_bitor '|' integer_bitxor  */
#line 451 "../git/dtc-parser.y"
                                           { (yyval.integer) = (yyvsp[-2].integer) | (yyvsp[0].integer); }
#line 1848 "dtc.p/dtc-parser.tab.c"
    break;

  case 56: /* integer_bitxor: integer_bitxor '^' integer_bitand  */
#line 456 "../git/dtc-parser.y"
                                            { (yyval.integer) = (yyvsp[-2].integer) ^ (yyvsp[0].integer); }
#line 1854 "dtc.p/dtc-parser.tab.c"
    break;

  case 58: /* integer_bitand: integer_bitand '&' integer_eq  */
#line 461 "../git/dtc-parser.y"
                                        { (yyval.integer) = (yyvsp[-2].integer) & (yyvsp[0].integer); }
#line 1860 "dtc.p/dtc-parser.tab.c"
    break;

  case 60: /* integer_eq: integer_eq DT_EQ integer_rela  */
#line 466 "../git/dtc-parser.y"
                                        { (yyval.integer) = (yyvsp[-2].integer) == (yyvsp[0].integer); }
#line 1866 "dtc.p/dtc-parser.tab.c"
    break;

  case 61: /* integer_eq: integer_eq DT_NE integer_rela  */
#line 467 "../git/dtc-parser.y"
                                        { (yyval.integer) = (yyvsp[-2].integer) != (yyvsp[0].integer); }
#line 1872 "dtc.p/dtc-parser.tab.c"
    break;

  case 63: /* integer_rela: integer_rela '<' integer_shift  */
#line 472 "../git/dtc-parser.y"
                                         { (yyval.integer) = (yyvsp[-2].integer) < (yyvsp[0].integer); }
#line 1878 "dtc.p/dtc-parser.tab.c"
    break;

  case 64: /* integer_rela: integer_rela '>' integer_shift  */
#line 473 "../git/dtc-parser.y"
                                         { (yyval.integer) = (yyvsp[-2].integer) > (yyvsp[0].integer); }
#line 1884 "dtc.p/dtc-parser.tab.c"
    break;

  case 65: /* integer_rela: integer_rela DT_LE integer_shift  */
#line 474 "../git/dtc-parser.y"
                                           { (yyval.integer) = (yyvsp[-2].integer) <= (yyvsp[0].integer); }
#line 1890 "dtc.p/dtc-parser.tab.c"
    break;

  case 66: /* integer_rela: integer_rela DT_GE integer_shift  */
#line 475 "../git/dtc-parser.y"
                                           { (yyval.integer) = (yyvsp[-2].integer) >= (yyvsp[0].integer); }
#line 1896 "dtc.p/dtc-parser.tab.c"
    break;

  case 67: /* integer_shift: integer_shift DT_LSHIFT integer_add  */
#line 479 "../git/dtc-parser.y"
                                              { (yyval.integer) = ((yyvsp[0].integer) < 64) ? ((yyvsp[-2].integer) << (yyvsp[0].integer)) : 0; }
#line 1902 "dtc.p/dtc-parser.tab.c"
    break;

  case 68: /* integer_shift: integer_shift DT_RSHIFT integer_add  */
#line 480 "../git/dtc-parser.y"
                                              { (yyval.integer) = ((yyvsp[0].integer) < 64) ? ((yyvsp[-2].integer) >> (yyvsp[0].integer)) : 0; }
#line 1908 "dtc.p/dtc-parser.tab.c"
    break;

  case 70: /* integer_add: integer_add '+' integer_mul  */
#line 485 "../git/dtc-parser.y"
                                      { (yyval.integer) = (yyvsp[-2].integer) + (yyvsp[0].integer); }
#line 1914 "dtc.p/dtc-parser.tab.c"
    break;

  case 71: /* integer_add: integer_add '-' integer_mul  */
#line 486 "../git/dtc-parser.y"
                                      { (yyval.integer) = (yyvsp[-2].integer) - (yyvsp[0].integer); }
#line 1920 "dtc.p/dtc-parser.tab.c"
    break;

  case 73: /* integer_mul: integer_mul '*' integer_unary  */
#line 491 "../git/dtc-parser.y"
                                        { (yyval.integer) = (yyvsp[-2].integer) * (yyvsp[0].integer); }
#line 1926 "dtc.p/dtc-parser.tab.c"
    break;

  case 74: /* integer_mul: integer_mul '/' integer_unary  */
#line 493 "../git/dtc-parser.y"
                {
...
#line 1939 "dtc.p/dtc-parser.tab.c"
    break;

  case 75: /* integer_mul: integer_mul '%' integer_unary  */
#line 502 "../git/dtc-parser.y"
                {
			if ((yyvsp[0].integer) != 0) {
				(yyval.integer) = (yyvsp[-2].integer) % (yyvsp[0].integer);
			} else {
...
#line 1952 "dtc.p/dtc-parser.tab.c"
    break;

  case 78: /* integer_unary: '-' integer_unary  */
#line 515 "../git/dtc-parser.y"
                            { (yyval.integer) = -(yyvsp[0].integer); }
#line 1958 "dtc.p/dtc-parser.tab.c"
    break;

  case 79: /* integer_unary: '~' integer_unary  */
#line 516 "../git/dtc-parser.y"
                            { (yyval.integer) = ~(yyvsp[0].integer); }
#line 1964 "dtc.p/dtc-parser.tab.c"
    break;

  case 80: /* integer_unary: '!' integer_unary  */
#line 517 "../git/dtc-parser.y"
                            { (yyval.integer) = !(yyvsp[0].integer); }
#line 1970 "dtc.p/dtc-parser.tab.c"
    break;

  case 81: /* bytestring: %empty  */
#line 522 "../git/dtc-parser.y"
                {
			(yyval.data) = data_add_marker(empty_data, TYPE_UINT8, NULL);
		}
#line 1978 "dtc.p/dtc-parser.tab.c"
    break;

  case 82: /* bytestring: bytestring DT_BYTE  */
#line 526 "../git/dtc-parser.y"
                {
			(yyval.data) = data_append_byte((yyvsp[-1].data), (yyvsp[0].byte));
		}
#line 1986 "dtc.p/dtc-parser.tab.c"
    break;

  case 83: /* bytestring: bytestring DT_LABEL  */
#line 530 "../git/dtc-parser.y"
                {
			(yyval.data) = data_add_marker((yyvsp[-1].data), LABEL, (yyvsp[0].labelref));
		}
#line 1994 "dtc.p/dtc-parser.tab.c"
    break;

  case 84: /* subnodes: %empty  */
#line 537 "../git/dtc-parser.y"
                {
			(yyval.nodelist) = NULL;
		}
#line 2002 "dtc.p/dtc-parser.tab.c"
    break;

  case 85: /* subnodes: subnode subnodes  */
#line 541 "../git/dtc-parser.y"
                {
			(yyval.nodelist) = chain_node((yyvsp[-1].node), (yyvsp[0].nodelist));
		}
#line 2010 "dtc.p/dtc-parser.tab.c"
    break;

  case 86: /* subnodes: subnode propdef  */
#line 545 "../git/dtc-parser.y"
                {
			ERROR(&(yylsp[0]), "Properties must precede subnodes");
			YYERROR;
		}
#line 2019 "dtc.p/dtc-parser.tab.c"
    break;

  case 87: /* subnode: DT_PROPNODENAME nodedef  */
#line 553 "../git/dtc-parser.y"
                {
			(yyval.node) = name_node((yyvsp[0].node), (yyvsp[-1].propnodename));
		}
#line 2027 "dtc.p/dtc-parser.tab.c"
    break;

  case 88: /* subnode: DT_DEL_NODE DT_PROPNODENAME ';'  */
#line 557 "../git/dtc-parser.y"
                {
			(yyval.node) = name_node(build_node_delete(&(yyloc)), (yyvsp[-1].propnodename));
		}
#line 2035 "dtc.p/dtc-parser.tab.c"
    break;

  case 89: /* subnode: DT_OMIT_NO_REF subnode  */
#line 561 "../git/dtc-parser.y"
                {
			(yyval.node) = omit_node_if_unused((yyvsp[0].node));
		}
#line 2043 "dtc.p/dtc-parser.tab.c"
    break;

  case 90: /* subnode: DT_LABEL subnode  */
#line 565 "../git/dtc-parser.y"
                {
			add_label(&(yyvsp[0].node)->labels, (yyvsp[-1].labelref));
			(yyval.node) = (yyvsp[0].node);
		}
#line 2052 "dtc.p/dtc-parser.tab.c"
    break;


#line 2056 "dtc.p/dtc-parser.tab.c"
